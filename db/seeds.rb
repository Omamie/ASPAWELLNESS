...
booking_attributes = [{customer: Customer.all.sample,treatment_id:Treatment.ids.sample, group_size: 2, start_time: "11/12/2019 15:00", end_time: "11/12/2019 18:00", status: 1, price_cents: 2000, duration: 60},
{customer: Customer.all.sample,treatment_id:Treatment.ids.sample, group_size: 3, start_time: "11/12/2019 15:00", end_time: "11/12/2019 18:00", status: 1, price_cents: 3000, duration: 90},
{customer: Customer.all.sample,treatment_id:Treatment.ids.sample, group_size: 2, start_time: "11/11/2019 15:00", end_time: "11/11/2019 16:00", status: 1, price_cents: 1800, duration: 120},
