...
center_attributes = [{name: "Spazio Salute", address: "Via Brera 46, 20121 Milano", contact_person: "Giulio Paci", owner_id: Owner.ids.sample, description: "We welcome you to the Spazio SoloSalute Cultural Association Amateur Sport Association in Milan. At our headquarters the Members found a HOLISTIC CENTER specialized in natural well-being with hydrocolon treatments in Milan, naturopathy and nutrition consultations, treatments such as ayurvedic massage and natural aesthetics, wellness and fitness courses to stay healthy in a natural way ."},
...
{name: "Prime Exclusive", address: "Via Svizzera 35, 00196 Roma", contact_person: "Francesco Verdi", owner_id: Owner.ids.sample, description: "PRIME is an ethical, holistic, modern and conscious view of total well-being. He has a soul and many expressions. Every component, every activity, every technology is part of a considered choice that aims to integrate perfectly into the PRIME system, a method of working on the person that we have defined as the Egosystem."},
...
{name: "Montenero Beauty Spa", address: "Via Arnolfo 45, 50121 Firenze", contact_person: "Paolo Goli", owner_id: Owner.ids.sample, description: "Montenero 8 Beauty & Luxury SPA è un centro elegante ed esclusivo situato nel cuore di Milano in prossimità della linea M3, fermata Porta Romana. In un ambiente rilassante e dotato di tutti i confort i nostri clienti ricevono le migliori cure per il benessere del corpo attraverso trattamenti eseguiti con tecnologie all’avanguardia, sofisticate tecniche di massaggio e cure della pelle"},
